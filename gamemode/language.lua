...
BaseWars.LANG.__LANGUAGELOOK.TURKISH = {
	CURRENCY								= CURRENCY,
	...
	FactionNameTaken				= "Bu ismi zaten kullanılıyor!",
	FactionNotExist					= "Böyle bir Takım yok!",
	FactionCantDisband			= "Sadece Takım Lideri atabilir!",
	FactionWrongPass				= "Hatalı Parola!",
	FactionCantLeaveLeader	= "Takım Kaptanı olarak ayrılamazsınız, Takımı dağıtın!",
	FactionCantPassword			= "Sadece Takım Lideri Parola değiştirebilir!",

	PayDay									= "PayDay! Aldın " .. CURRENCY .. "%s!",

	DontBuildSpawn					= "Spawn alanında Props yapmayın.",
	SpawnKill								= "Spawnkill Yapmayınız.",
	SpawnCamp								= "Spawn Kamp yapmayınız.",

	RaidOngoing							= "Halen devam eden bir Raid var!",
	RaidSelfUnraidable			= "You are not raidable yourself! (%s)",
	RaidTargetUnraidable		= "Your target is not raidable! (%s)",
	RaidOver								= "Raid %s ve %s arasında Bitecektir.!",
	RaidStart								= "Raid %s ve %s Başladı!",
	RaidTargNoFac						= "You cannot raid a factionless player as a faction!",
	RaidSelfNoFac						= "You cannot raid a faction as a factionless player!",
	RaidNoFaction						= "Raid sırasında başka bir raid yapamazsınız!",
	CantRaidSelf						= "You can't raid yourself or your faction!",

	CannotPurchaseRaid			= "Raid Sırasında Satın Alamazsınız!",
	...
	PowerFailure						= "GÜÇ YOK!",
	HealthFailure						= "KRİTİK HASAR!",

	NewSpawnPoint						= "Your new SpawnPoint has been set!",

	UseSpawnMenu						= "Use the BaseWars spawnlist!",
	SpawnMenuMoney					= "Yeterli Paranız Yok.",
	SpawnMenuBuy						= "You bought a(n) \"%s\" for " .. CURRENCY .. "%s.",
	SpawnMenuBuyConfirm			= "Are you sure you want to by a(n) \"%s\" for " .. CURRENCY .. "%s?",
	SpawnMenuConf						= "Satın Alma Onayı",
	DeadBuy									= "Ölüler bişey satın alamazlar.",
	EntLimitReached					= "Sınırınıza Ulaştınız \"%s\"s.",

	StuckText								= "You are stuck inside a wall, prop, or player! Remain calm and press [CTRL], if it does not work press [SPACE].",

	FailedToAuth						= "Steam Kimlik doğrulaması başarısız oldu SteamID !",

	MainMenuControl					= "F3 - Ana Menü (Kurallar, Takım, Raids)",
	SpawnMenuControl				= " - Satın Alma Menü (Entities, Weapons)", -- Key is detected automatically, do not add one.
	KarmaText								= "Your Karma is currently %s",
	LevelText               = "Level: %s",
	XPText                  = "%s/%s XP",
	...
	UpgradeNoMoney					= "Yükseltmek için yeterli paranız yok!",
	UpgradeMaxLevel					= "Bu yazıcıyı artık yükseltemezsiniz!",

	WelcomeBackCrash				= "Tekrar hoş geldiniz, en son oynadığınız an crash aldınız.",
	Refunded								= "Geri verdiniz " .. CURRENCY .. "%s.",

	GivenMoney							= "%s sana verdi " .. CURRENCY .. "%s.",
	GaveMoney								= "Verdiğiniz %s " .. CURRENCY .. "%s.",

	BountyNotEnoughMoney		= "You don't have enough money to place bounty.",

	InvalidPlayer						= "Gçersiz Oyuncu!",
	InvalidAmount						= "Geçersiz Tutar!",
	TooPoor									= "Bu işlem için yetersizsin!",
}

local INVALID_LANGUAGE	= "GEÇERSIZ DİL SEÇİLDİ! SUNUCU YÖNETİMİNİ BİLDİRİN!"
local INVALID_STRING		= "GEÇERSİZ TERCÜME ÇEVİRİSİ! SUNUCU YÖNETİMİNİ BİLDİRİN!"
